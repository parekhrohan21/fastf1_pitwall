...
15. **Championship Standings & Classification** — Scroll to the very bottom to view the Constructors' Championship standings (dynamically matched to constructor colors) and the official final standings table (with points, retirements/laps, stops, and Q1/Q2/Q3 split times where applicable).
