...
### Block 1 — Design System (lines 143–607)
...
### Block 2 — Theme Override (lines 608–777)
...
When you add a new Streamlit component that doesn't respond to theme changes, add a CSS override to the **Theme CSS block** (lines 608–777):
