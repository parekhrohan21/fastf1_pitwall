...
`COMPOUND_COLOURS` in the Constants block (~line 1322) is the **single source of truth** for all compound colours. Every consumer in the codebase derives from it — no inline dicts anywhere.
...
### Block 1 — Design System (lines 507–1098)
...
### Block 2 — Theme Override (lines 1099–1268)
...
When you add a new Streamlit component that doesn't respond to theme changes, add a CSS override to the **Theme CSS block** (lines 1099–1268):
