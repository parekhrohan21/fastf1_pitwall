...
| `tests/` | Pytest unit and integration tests (e.g. `test_speed_trap.py`, `test_gear_shifts.py`, `test_braking_analysis.py`, `test_telemetry_export.py`, `test_telemetry_channels.py`, `test_tyre_crossover.py`, `test_cf.py`). |
